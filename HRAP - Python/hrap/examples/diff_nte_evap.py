...
# Roughly calculate diffusion coefficient - not relevant, extremely small, BL would have to be microscopic
# mu = 1.5E-4 # TODO: better
# k_B = 1.381E-23 # J/K
# r = 187E-12 # m, effective radius of 
# D = k_B*294 / (4 * np.pi * mu * r)
# print('D', D)
